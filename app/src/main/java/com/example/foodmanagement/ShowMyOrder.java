...
public class ShowMyOrder extends AppCompatActivity implements OrderAdapter.OnItemClickListener {

    OrderAdapter orderAdapter;
    String URL="https://foodapi-tsul.onrender.com/api/v1/getFoodByUploadedUser";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(array.length()>0){
                        ...
                        RecyclerView recyclerView = findViewById(R.id.recyclerViewShowMyOrder);
                        recyclerView.setVisibility(View.VISIBLE);
                        recyclerView.setLayoutManager(new LinearLayoutManager(ShowMyOrder.this));
                        ...
                        Toast.makeText(ShowMyOrder.this, "No item is found", Toast.LENGTH_SHORT).show();
                    }

                }catch (JSONException e){
                    e.printStackTrace();
                    Toast.makeText(ShowMyOrder.this, "Internal error", Toast.LENGTH_SHORT).show();
